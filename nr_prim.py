'''Subprogram celmd, with one parameter:
...
a) Write the complete definition of the subprogram celmd.
...
being strictly greater than 1. Using useful subprogram calls celmd, the program will
